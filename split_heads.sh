#!/usr/bin/env bash
 python tools/train_net.py --config-file "configs/polyp/baselines/faster_R_50_FPN_base.yaml" OUTPUT_DIR "results/split_head/mask_base" MODEL.ROI_HEADS.BOX_HEAD_TYPE "double" MODEL.MASK_ON True
