#!/usr/bin/env bash
python tools/train_net.py --config-file "configs/polyp/mod_rpn/faster_R_50_FPN_base.yaml"
python tools/train_net.py --config-file "configs/polyp/mod_rpn/faster_R_50_FPN_base.yaml" MODEL.MASK_ON True OUTPUT_DIR "results/mod_rpn/mask/video_base" MODEL.WEIGHTS "detectron2://COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_1x/137260431/model_final_a54504.pkl"
